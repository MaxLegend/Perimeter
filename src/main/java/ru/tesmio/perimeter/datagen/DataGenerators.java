package ru.tesmio.perimeter.datagen;
...
import ru.tesmio.perimeter.datagen.generators.*;

import java.util.concurrent.CompletableFuture;

@Mod.EventBusSubscriber(modid = Perimeter.MODID, bus = Mod.EventBusSubscriber.Bus.MOD)
public class DataGenerators {
    ...
    public static void gatherData(GatherDataEvent event) {
        ...
        BlockTagGenerator btg = generator.addProvider(event.includeServer(),

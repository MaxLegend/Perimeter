...
public class BlockNetworkSavedData extends SavedData {
    ...
    public static BlockNetworkSavedData get(ServerLevel level) {
        return level.getDataStorage().computeIfAbsent(
                BlockNetworkSavedData::load,
                BlockNetworkSavedData::new,
                "perimeter_saved_data"
        );
    }

    public BlockNetworkSavedData() {
    }

    public static BlockNetworkSavedData load(CompoundTag tag) {
        BlockNetworkSavedData data = new BlockNetworkSavedData();
